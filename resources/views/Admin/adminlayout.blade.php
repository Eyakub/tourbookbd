...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{URL::to('admin-panel')}}"><img src="{{asset('images/logo.png')}}" alt="Logo"></a>
...
<script src="{{URL::to('https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js')}}"></script>
...
<script src="{{URL::to('assets/js/lib/vector-map/jquery.vmap.js')}}"></script>
<script src="{{URL::to('assets/js/lib/vector-map/jquery.vmap.min.js')}}"></script>
