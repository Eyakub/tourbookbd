...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{URL::to('admin-panel')}}"><img src="images/logo.png" alt="Logo"></a>
            <a class="navbar-brand hidden" href="{{URL::to('admin-panel')}}"><img src="images/logo2.png" alt="Logo"></a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="{{URL::to('/tours-table')}}">Data Table</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="user-avatar rounded-circle" src="images/eyakub.jpg" alt="User Avatar">
                    </a>
