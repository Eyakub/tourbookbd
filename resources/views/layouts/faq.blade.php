...
<section class="parallax-window" data-parallax="scroll" data-image-src="{{asset('storage/large_cover/1539129351-470x1400.JPG')}}" data-natural-width="1400" data-natural-height="470">
    <div class="parallax-content-1">
        <div class="animated fadeInDown">
            ...
            <p>You may have a lot question, this may help you.</p>
        </div>
    </div>
</section>
<!-- End section -->
        ...
        <div class="row">
            <aside class="col-lg-3 col-md-3">
                ...
                <div class="box_style_2">
                    ...
                    <a href="tel://01937424217" class="phone">+880 1937424217</a>
            ...
            <div class="col-lg-9 col-md-9" id="faq">
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Anim pariatur cliche reprehenderit?<i class="indicator icon-minus pull-right"></i></a>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Ad vegan excepteur butcher ?<i class="indicator icon-plus pull-right"></i></a>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Ad vegan excepteur butcher vice lomo?<i class="indicator icon-plus pull-right"></i></a>
                            </h4>
                        </div>
...
<!-- Specific scripts -->
<!-- Cat nav mobile -->
<script src="{{URL::asset('js/cat_nav_mobile.js')}}"></script>
<script>
    $('#cat_nav').mobileMenu();
</script>
