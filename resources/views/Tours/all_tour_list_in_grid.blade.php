    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-3">
                <div id="logo">
                    <a href="{{URL::to('/')}}"><img src="img/tourbookbd.png" width="160" height="34" alt="City tours" data-retina="true" class="logo_normal">
                    </a>
                    <a href="{{URL::to('/')}}"><img src="img/tourbookbd.png" width="160" height="34" alt="City tours" data-retina="true" class="logo_sticky">
                    </a>
                </div>
            </div>
