            ...
            <nav class="col-md-9 col-sm-9 col-xs-9">
                ...
                <div class="main-menu">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="bd_resorts.html">Resorts <i class="icon-down-open-mini"></i></a>
                        </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-3">
                <h3>Need help?</h3>
                <a href="tel://004542344599" id="phone">+8801937424217</a>
                <a href="mailto:help@citytours.com" id="email_footer">eyakubso@gmail.com</a>
            </div>
